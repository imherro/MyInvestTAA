...
def validate_approval_integrity(
    *,
    ...
    if mapping_hash != record.get("mapping_after_hash"):
        mapping_errors.append("current mapping hash does not match approval record")
...
def _consistency_errors(
    *,
    ...
    if record.get("mapping_after_hash") != actual_mapping_hash:
        errors.append("approval record mapping after hash mismatch")
