...
from backtest.execution.proposal_report import COUNTER,PROPOSAL,build_counterfactual_baseline_contract,write_report
...
report={"available":True,"status":"current","evidence_use":"current_analysis","data_provider":provider,"dataset_provenance":provenance,"baseline_contract":build_counterfactual_baseline_contract(),"baseline":baseline,"counterfactual":counter,"common_comparison_period":common,"impact":impact,"proxy_collision_diagnostics":collisions,"decision":{"ready_for_manual_mapping_approval":not reasons,"reasons":reasons,"warning":"Counterfactual proposal only; asset_mapping.json has not been modified."}};write_report(report,COUNTER);print({"ready":not reasons,"impact":impact})
